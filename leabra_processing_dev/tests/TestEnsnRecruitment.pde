class TestEnsnRecruitment {
    ...
    Connection PEdACC_conn_0; // support to hidden, CtxPredError
    Connection PEdACC_conn_1; // support to hidden, CtxPredError
    Connection dACCC_conn_0; // dACC to context
    Connection dACCC_conn_1; // dACC to context
    Connection dACC_01_conn; // ensemble 0 to 1, inhibitive such that second comes into effect if first is reduced
    ...
    TestEnsnRecruitment() {
        ...
        PEdACC_conn_0 = new Connection(predictionerror_layer, dACC_layer_0, onetoone_excite_weak_spec);
        PEdACC_conn_1 = new Connection(predictionerror_layer, dACC_layer_1, onetoone_excite_weak_spec);
        dACCC_conn_0 = new Connection(dACC_layer_0, context_layer, onetoone_excite_spec);
        dACCC_conn_1 = new Connection(dACC_layer_1, context_layer, onetoone_excite_spec);
        dACC_01_conn = new Connection(dACC_layer_0, dACC_layer_1, full_inh_spec);
