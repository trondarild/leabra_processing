class TestIntegrator {
    String modelname = "Test leaky integrator";
    ...
    // integrators
    LeakyIntegratorSpec li_spec = new LeakyIntegratorSpec();
    LeakyIntegrator li;
    ...
    TestIntegrator () {
        ...
        // leaky integrator
        li_spec.decayfactor = 0.1;
        li = new LeakyIntegrator(li_spec, DOPAMINE);
    ...
    void tick() {
        ...
        li.setInput(input_layer.getOutput()[0]);
        li.cycle();
        netw.cycle();
    ...
    void draw() {
        ...
        pushMatrix();
            ...
            translate(0, 20);
            pushMatrix();
            text("LeakyIntegrator: " + li.getBuffer().array()[0], 0,0);
            pushMatrix();
            translate(100, -10);
            //drawColGrid(0,0, 10, multiply(200, dacc_viz));
            drawTimeSeries(li.getBuffer().array(), 10.0, 1, 0);
            popMatrix();
            popMatrix();
