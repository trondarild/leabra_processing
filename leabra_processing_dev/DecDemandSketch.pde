class DecDemandSketch {
    ...
    int colorsize = 4;
    int numsize = 10;
    int rulectxsize = 2; // use "even" or "<5" rule? input from color
    int rulesize = 20; // 10 + 10 rules, dept on rule ctx/color
    ...
    Layer color_layer; // code color of number
    Layer number_layer; // code number value
    Layer rulectx_layer; // code which rule context is online, effortful to change
    Layer rule_layer;
