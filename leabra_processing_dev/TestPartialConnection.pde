...
class TestPartialConnection {
    ...
    TestPartialConnection() {
        ...
        edge_left_spec.pre_endix = 0;
        edge_left_spec.post_startix = 1;
        edge_left_spec.post_endix = 2;

        edge_right_spec.pre_startix = 2;
        edge_right_spec.pre_endix = 2;
        edge_right_spec.post_startix = 0;
        edge_right_spec.post_endix = 1;

        middle_spec.post_startix = 1;
        middle_spec.post_endix = 1;
        ...
        // connections
        IH_conn = new Connection(input_layer, hidden_layer, middle_spec);
